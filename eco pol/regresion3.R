...
data<-read.xlsx('C:/Users/Admin/Documents/GitHub/pruebas/eco pol/regresion.xlsx',sheet="regresion3")
...
datosFm_Eco <- data.frame(voto, P1E, P2E, P3E, P4E, P5E, P6E, P7E, P8E )

datosFm_Eco$predicciones <- predict(modeloEco, type = "response")

write_xlsx(datosFm_Eco, "prediccion_Eco3.xlsx")
...
write_xlsx(datosFm_Ec, "prediccion_Ec3.xlsx")
...
write_xlsx(datosFm_Tot, "prediccion_Tot3.xlsx")
